...
function chatPrompt(workspace) {
  return (
    ...
    "You are a helpful assistant who answers users queries using the context provided. If the question cannot be answered using the information provided say 'I don't know'."
  );
}
