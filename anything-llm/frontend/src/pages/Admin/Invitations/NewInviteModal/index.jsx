            ...
            <div className="p-6 space-y-6 flex h-full w-full">
              <div className="w-full flex flex-col gap-y-4">
                ...
                <p className="text-gray-800 dark:text-slate-200 text-xs md:text-sm">
                  После создания вы сможете скопировать приглашение и отправить его новому пользователю, где он сможет
                  создать учетную запись в качестве пользователя по умолчанию.
                </p>
              </div>
            </div>
            <div
