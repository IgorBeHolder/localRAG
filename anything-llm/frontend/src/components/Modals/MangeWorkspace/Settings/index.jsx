          ...
          <div className="w-full flex flex-col gap-y-4">
            ...
            <div>
              <div className="flex flex-col gap-y-1 mb-4">
                ...
                <p className="text-xs text-gray-600 dark:text-stone-400">
                  ...
                  <br/>
                  Чем выше число (максимум 2.0), тем более случайным и бессвязным.
                  <br/>
                  Рекомендуется: 0.7
                </p>
              </div>
            ...
            <div>
              <div className="flex flex-col gap-y-1 mb-4">
                ...
                <p className="text-xs text-gray-600 dark:text-stone-400">
                  Приглашение, которое будет использоваться в этом рабочем пространстве. Определите контекст и
                  инструкции для
            ...
            <div>
              <div className="flex flex-col gap-y-1 mb-4">
                ...
                <p className="text-xs text-gray-600 dark:text-stone-400">
                  ...
                  <br/>
                  Рекомендуется 20. Если значение больше 45, это может привести к постоянным сбоям в чате в зависимости
